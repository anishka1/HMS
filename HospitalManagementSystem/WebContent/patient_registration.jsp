		...
		<div class="container main1">
			...
			<fieldset>
				<form action="AddCustomer" method="post">
					...
					<div class="main">
						<h1 style="margin-left: 25%;">Patient Registration</h1>
					</div>
					<div class="main">
						<label for="customer">Pateint SSN Id : </label> <input type="text"
					...
					<div class="main">
                      ...
                      <select class="select1" name="typeofed" id="cars">
                            <option value=""></option>
					...
					<div class="main">
						<label for="address">Address <span style="color:red">*</span></label> <input type="text"
